              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        const Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 3),
                              Text(
                                'Record a cash, mobile money, or bank repayment.',
                                style: TextStyle(
                                  color: AppColors.muted,
                                  fontSize: 12.5,
                                  fontWeight: FontWeight.w600,
                    ...
                    detailAsync.when(
                      loading: () => const _SheetLoadingSummary(),
                      error: (_, __) => const _SheetDebtSummaryError(),
                      data: (detail) {
                        if (detail == null) return const _SheetDebtSummaryError();
                        final row = detail.record;
                        return _PaymentDebtSummary(
                          customerName: row.customerName,
                          outstandingAmount: _formatMoney(row.outstandingAmount),
                          dueDate: _formatDueDate(row.dueDateIso),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'This records a repayment and updates the outstanding balance after saving.',
                              style: TextStyle(
...
class _PaymentDebtSummary extends StatelessWidget {
  const _PaymentDebtSummary({
...
class _SheetLoadingSummary extends StatelessWidget {
  const _SheetLoadingSummary();
...
class _SheetDebtSummaryError extends StatelessWidget {
  const _SheetDebtSummaryError();
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Could not load the debt summary. You can close and try again.',
              style: TextStyle(
