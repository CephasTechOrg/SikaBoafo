      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Opacity(
              opacity: 0.45,
              child: Image.asset('assets/images/inventory.png', height: 110,
                  errorBuilder: (_, __, ___) => const Icon(Icons.inventory_2_outlined, size: 80, color: AppColors.muted)),
            ),
            const SizedBox(height: 24),
            const Text(
              'No items yet',
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            const Icon(Icons.archive_outlined, size: 18, color: AppColors.muted),
            const SizedBox(width: 10),
            Text(
              'Archived Items ($archivedCount)',
              style: const TextStyle(
